...
#define ZMKHIDIO_USAGE16(a, b) HID_ITEM(HID_ITEM_TAG_USAGE, HID_ITEM_TYPE_LOCAL, 2), a, b

#define ZMKHIDIO_USAGE16_SINGLE(a) ZMKHIDIO_USAGE16((a & 0xFF), ((a >> 8) & 0xFF))
...
static const uint8_t zmk_hid_report_desc_alt[] = {
    ...
    ZMKHIDIO_USAGE16_SINGLE(HID_USAGE_CONSUMER_AC_PAN),
    HID_LOGICAL_MIN16(0xFF, -0x7F),
    HID_LOGICAL_MAX16(0xFF, 0x7F),
    HID_REPORT_SIZE(0x08),
    HID_REPORT_COUNT(0x01),
